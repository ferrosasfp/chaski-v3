...
import { SolanaWalletAdapter } from "../infrastructure/solana-wallet"; import { FirmaPorEnlaceReal } from "../infrastructure/solana/deeplink/firma-por-enlace"; import { RecorridoPorEnlaceReal, type PreparacionPorEnlace } from "../infrastructure/solana/preparacion-por-enlace"; // WKH-358: EN ESTA LÍNEA, no en una nueva — este archivo recibe 40 citas ancladas y TODAS apuntan de `:48` para abajo, así que una línea nueva en el bloque de imports las rota a las 40 (medido). Precedente con su motivo escrito: `solana-wallet.ts:47`, siete imports en una línea. ⚠️ Y esta línea tiene que seguir conteniendo `SolanaWalletAdapter`, que es lo que cita `flow.tsx` por número
