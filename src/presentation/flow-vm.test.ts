...
describe("WKH-352 · `absent` con prueba local del depósito", () => {
  ...
  // `flow.tsx:873`), que es la puerta que le queda. Argumento largo en el docblock de
  ...
  //       (`LostEscrowRecovery`, `flow.tsx:2154`) la encuentra porque resuelve por sender. Mandar a un
