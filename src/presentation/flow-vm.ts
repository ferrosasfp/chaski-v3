 ...
 *      `sender`, y (`prepare_kyc_verdict_missing`, `../../app/api/payout/prepare/route.ts:311`) exige la fila del veredicto SIN respaldo. Ninguna remesa deposita sin que el
