...
// `flow.tsx` —[[CENSO src/presentation/flow.tsx lineas=4453]] líneas y [[CENSO src/presentation/flow.tsx entrantes=165]] citas ancladas— no recibe ni una línea por este bloque. Lo que sí necesita de
