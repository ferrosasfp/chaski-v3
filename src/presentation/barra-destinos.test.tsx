...
describe("T-063-21 (AR-it2/BLQ-MED-1): la ventana previa a la primera respuesta ya no pisa la elección", () => {
  ...
  it("🔴 la pantalla que la persona eligió SOBREVIVE, y el aviso dice que la verificación está lista", async () => {
    ...
    //     (`AbortSignal`, `../infrastructure/kyc/agent-kyc-client.ts:199` — WKH-233 lo movió: el `fetch` del borde salió de la route y vive en el cliente del agente, con el MISMO techo de 10 s), así que son HASTA 10 s cuando la
