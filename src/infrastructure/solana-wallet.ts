    ...
    ConnectedWalletProbe
{
   ...
   *
   * POR QUÉ EXIGE `remittanceId` Y `refundEscrow` NO: el fallback de refund (`refundEscrow`, `:578`,
   ...
   * (`ComputeBudgetProgram.setComputeUnitLimit`, `:422`): aquello existía por el
