 ...
 * recibe. Son los seis de (`EscrowChainState`, `../application/ports.ts:1105`) más DOS que no hablan
 ...
 * ver R-1 en el docblock de (`EscrowChainState`, `../application/ports.ts:1105`).
 *
