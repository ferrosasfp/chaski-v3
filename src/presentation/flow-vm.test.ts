...
describe("WKH-352 · `absent` con prueba local del depósito", () => {
  ...
  it("T-W4: `refunded` sin el marcador del sender pero CON depósito confirmado recibe la frase nueva", () => {
    ...
    r.markPrincipalIn("solana-sig-principal", T); // confirm-and-send.ts:497, tras el `ok:true` del settle
    r.markPayoutSubmitted("transfi-po-1", T, "transfi"); // confirm-and-send.ts:503
