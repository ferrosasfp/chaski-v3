 ...
 *  USDC.", `flow.tsx:2621`), aunque nombre la misma acción. Mi primera versión la copiaba tal cual para
 ...
 * (`idsAConsultar`, `flow.tsx:3206`), y (`escrowOutcome`, `:1193`) devuelve el conocimiento local tal cual con `"not-asked"`)
