...
| WKH-181 | [P1] No persistir PII cruda + historial por-wallet + riskLevel AML | in progress (F1, 2026-07-11) | `doc/sdd/004-wkh-181-pii-persistence-history-per-wallet/work-item.md` |
