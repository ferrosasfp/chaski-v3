 ...
 * `flow.tsx:1351`. `T-341-11` no renderiza `NoWalletHere`, así que por sí solo NO prueba la pantalla.
 *
 ...
 *
 * ⚠️ NO la unifiques con el poll de 1500 ms del seguimiento (`flow.tsx:661`). Coinciden en el número
