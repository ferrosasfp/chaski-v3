  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        // `Record` con todas (once al cerrar la ola 4, trece desde el fix-pack), escribir una sola acá lo rompe a propósito.
        limpiarLaBarra();
