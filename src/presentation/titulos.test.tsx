...
// bloques como "Recuperar un envío perdido" (`h2`, `flow.tsx:2486`) se pintan dentro del paso `send`, que
...
describe("D-3 · la primera pantalla ya no es un bloque plano", () => {
  ...
  it("el nombre de la app es el `<h1>`, y es UNO solo", () => {
    // INPUT QUE LO PONE EN ROJO: devolver el título del header a un párrafo (`h1`, `flow.tsx:693`).
    //
