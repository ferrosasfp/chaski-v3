 ...
 * (`resolveRemittanceIdFromLedger`, `solana-wallet.ts:323`), y el gateway está cableado en el
...
// del MISMO valor que el depósito escribe como deadline (`CUSTODY_WINDOW_SECS`, `solana-wallet.ts:416`), así que no puede
