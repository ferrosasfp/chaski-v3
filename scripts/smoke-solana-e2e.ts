 ...
 *  (`remittanceIdToBytes16`, `solana-wallet.ts:250`), reproducible server-side para re-derivar la
...
async function main(): Promise<void> {
  ...
  // `escrowIdl as Idl` es el IDL genérico ⇒ acceso vía shape loose (patrón `program.methods`, `solana-wallet.ts:457`).
