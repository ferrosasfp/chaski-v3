 ...
 * `flow.tsx:1186`. `T-341-11` no renderiza `NoWalletHere`, así que por sí solo NO prueba la pantalla.
 *
 ...
 *
 * ⚠️ NO la unifiques con el poll de 1500 ms del seguimiento (`flow.tsx:599`). Coinciden en el número
