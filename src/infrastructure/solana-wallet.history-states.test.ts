...
describe("SolanaWalletAdapter.readEscrowStates (WKH-349)", () => {
  ...
  // rechaza por deadline (`refund_before_deadline`, `solana-wallet.ts:1125`): a esa altura aquél YA NO
...
// (`refund_before_deadline`, `solana-wallet.ts:1125`) —o sea el refund rechazando EN el deadline
...
describe("readEscrowStates ⇄ refundEscrow — el acople de AC-13, con las dos funciones corriendo", () => {
  ...
  // el guard del refund (`solana-wallet.ts:1125`). Con él, esta línea se pone roja por
