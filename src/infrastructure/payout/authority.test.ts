...
describe("T-AUTH-6: si el token fue invalidado, el agente contesta 401 y NO se reintenta", () => {
  ...
  // de (`payout_authority_unavailable`, `../../../app/api/payout/prepare/route.ts:408`) ⇒
  // `payout_authority_unavailable` ⇒ el `case` 1:1 de
  // (`payout_authority_unavailable`, `../settlement/http-solana-prepare-gateway.ts:81`) ⇒
  // `payout_authority_unavailable` como `failureReason`
