...
// `authorizePrincipal`, `solana-wallet.ts:377`). Si el IDL cambia de forma, el lector cambia con él, y el test que decodifica
...
export async function readDepositBeneficiary(
  ...
  try {
    ...
    // deserializa acá y cae a `unreadable`: hoy el escritor arma una legacy (`authorizePrincipal`, `solana-wallet.ts:377`) y
