...
// contrato (ATA de la PDA `escrowStatePda`, `solana-wallet.ts:597`), nunca en una billetera de Chaski.
...
describe("la identidad del paso confirm", () => {
  ...
  // quedaba sin ningún aviso también en seguimiento, y lo mismo en el recibo (`Receipt`, `flow.tsx:3252`,
