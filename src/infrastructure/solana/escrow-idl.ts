...
// COPIA PINNEADA del IDL del programa escrow Anchor. El original se genera en el repo
// `solana-programs` (target/idl/escrow.json) y acá se COPIA, NO se edita: como vive fuera de
// este repo no se puede importar por path relativo, y el hash canónico lo candea en tests.
