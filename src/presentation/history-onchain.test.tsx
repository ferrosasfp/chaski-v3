...
describe("WKH-349 · el historial pregunta por el bucket que no sabe, y dice qué contestó", () => {
  ...
  // `flow.tsx:3284` este archivo queda VERDE (10 passed): el rojo lo da T-N1, mitad (c), en
  ...
  // a `HistoryEntry` (`flow.tsx:3284`) pone rojo el assert de ausencia de abajo. ⚠️ Lo que NO caza es un
  ...
  // MUTANTE (b) MEDIDO — DIBUJAR LAS DOS: un `<p>` de más en `flow.tsx:3284` con
  ...
  // MUTANTE MEDIDO: en `HistoryEntry` (`flow.tsx:3259`), agregar
