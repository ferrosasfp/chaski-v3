...
//     `../application/use-cases/confirm-and-send.ts:390`).
...
describe("el precio dice qué es y quién lo cobraría", () => {
  ...
  it("T-R1d: la cotización en gateway y la entrega en demo ⇒ NO puede decir que la cotización la armó la app", async () => {
    ...
    // apagado no se simula, se corta (`this.solana`, `../application/use-cases/confirm-and-send.ts:390`).
  ...
  // `../application/use-cases/confirm-and-send.ts:390`). Ahora la nota se acota NOMBRANDO la pata de la
